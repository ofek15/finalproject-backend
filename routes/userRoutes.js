...
const { fetchUser, publishUser, deleteUser, updateUser, loginFunc, loginFuncFromVerify, translateToken, findUserById, findUserExists, changePassword, loginFuncFromToken, activeLicense} = require('../controllers/userController')
...
router.patch('/activeLicense', activeLicense)
